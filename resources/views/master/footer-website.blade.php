        ...
        <div class="wrap">
            ...
            <div class="same-padd">
                ...
                <div class="social">
                    ...
                    <li><a href="{{$data_array['fb']}}"><img src="{{ URL::asset('public/website/images/fb.png') }}" alt=""></a></li>
                    <li><a href="{{$data_array['twitter']}}"><img src="{{ URL::asset('public/website/images/tw.png') }}" alt=""></a></li>
                    <li><a href="{{$data_array['linkedin']}}"><img src="{{ URL::asset('public/website/images/link.png') }}" alt=""></a></li>
                    <li><a href="{{$data_array['pinterest']}}"><img src="{{ URL::asset('public/website/images/pin.png') }}" alt=""></a></li>
                    <li><a href="skype:{{$data_array['skype']}}?chat:"><img src="{{ URL::asset('public/website/images/skype.png') }}" alt=""></a></li>
                    <li><a href="{{$data_array['gplus']}}"><img src="{{ URL::asset('public/website/images/google.png') }}" alt=""></a></li>
                </div><!--/.social --> 
            </div><!--/.same-padd --> 
        </div><!--/.wrap --> 
