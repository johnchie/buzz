    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Create Category</span></h4>
            </div>
    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Create New Category<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                <div class="heading-elements">
                </div>
            </div>
            ...
            <div class="panel-body">
               ...
               <?php  $error_keys = array(); ?>
                ...
                @endif
                <form class="form-horizontal" action="{{ url('/admin/store-category')  }}" method="post">
                    <!-- usable -->
                    <fieldset class="content-group">
                        <legend class="text-bold">Please use below form to create new category</legend>
                        <div class="form-group @if(in_array('name',$error_keys)) {{ "has-error" }}   @endif">
                            <label class="control-label col-lg-2">New Category Name</label>
                            <div class="col-lg-10">
                                <div class="row">
                                    <div class="col-md-4">
